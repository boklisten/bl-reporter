...
describe('PaymentDownloadService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [
        { provide: PaymentService, useValue: jasmine.createSpyObj('PaymentService', ['get']) },
        { provide: ExcelService, useValue: jasmine.createSpyObj('ExcelService', ['objectsToExcelFile'])}
      ]
    })
  });
  ...
  describe('#getPaymentsByFilter', () => {
    ...
    describe('when filter is provided', () => {
      it('should return payments when returned from api', (done) => {
        ...
        paymentDownloadService.getPaymentsByFilter(filter).then((downloadedPayments) => {
