...
describe('CustomerItemDownloadService', () => {
  ...
  beforeEach(() => {
    const excelServiceSpy = jasmine.createSpyObj('ExcelService', [ 'objectsToExcelFile' ]);
    const customerItemServiceSpy = jasmine.createSpyObj('CustomerItemService', ['get']);
  ...
  it('should be created', () => {
    const service: CustomerItemDownloadService = TestBed.get(CustomerItemDownloadService);
